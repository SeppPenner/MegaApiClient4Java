...
public class Crypto {
    ...
    private static final Rijndael RijndaelCbc;
    private static final byte[] DefaultIv = new byte[16];
    ...
    public static Attributes DecryptAttributes(byte[] attributes, byte[] nodeKey) {
        ...
        try {
            ...
            return new Attributes(String.Format("Attribute deserialization failed: {0}", ex.getMessage()));
        }
    }
